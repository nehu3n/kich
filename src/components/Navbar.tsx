import kichIcon from "../../public/kich_icon.png";
...
function SideBarComponent() {
  return (
    <div className="bg-white shadow-sm h-screen w-60 py-4 px-3">
      ...
      <hr className="mt-4" />
      <div className="mt-2">
        <span className="text-gray-400 text-sm font-extrabold">
          Accounts tags
        </span>
      ...
      <div className="absolute bottom-0 left-0 right-0 inline-flex mb-2 ml-3">
        <span className="ml-1 mt-1 text-gray-700 text-lg font-bold">Kich</span>
        <a href="" className="ml-36 relative">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
